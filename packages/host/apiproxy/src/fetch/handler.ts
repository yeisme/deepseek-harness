...
import {
  ...
  sessionForkBeforeMessageRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.forkBeforeMessage': { schema: sessionForkBeforeMessageRequestSchema, invoke: (api, r) => api.sessions.forkBeforeMessage(r) },
